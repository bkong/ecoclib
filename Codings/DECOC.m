...
function ECOC=DECOC(classes,data,criterion_sffs,iterations_sffs,show_info)

ECOC=rec_decoc([],1:length(classes),data,iterations_sffs,criterion_sffs,show_info);
